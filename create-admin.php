...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   list ($error, $tMessage, $pAdminCreate_admin_username_text, $pAdminCreate_admin_password_text) = create_admin($fUsername, NULL, NULL, $fDomains);
...
include ("$incpath/templates/admin_create-admin.php");

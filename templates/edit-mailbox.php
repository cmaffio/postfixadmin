...
<table>
   ...
   <tr>
      <td><?php print "Gruppo di appartenenza:"; ?></td>
<?php if (authentication_get_usertype () == "global-admin") { ?>
      <td><input class="flat" type="text" name="focgroup" value="<?php print htmlspecialchars ($tocgroup,ENT_QUOTES); ?>" /></td>
<?php } else {?>
      <td><?php print htmlspecialchars ($tocgroup,ENT_QUOTES); ?></td>
<?php } ?>
      <td><?php print "Gruppi su owncloud"; ?></td>
   </tr>
